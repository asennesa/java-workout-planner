...
export const EditExerciseModal = ({ isOpen, exercise, onClose, onUpdated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      setError(null);
      const updatedExercise = await apiService.updateExercise(exercise.exerciseId, formData);
...
EditExerciseModal.propTypes = {
  ...
  exercise: PropTypes.shape({
    ...
    targetMuscleGroup: PropTypes.string,
